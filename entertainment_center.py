...
The webpage will display the movie poster, allow the user to click on it, and play the trailer.
"""

import fresh_tomatoes
import media

#The following instances are listed displaying favorite movies by title, storyline, poster URL, and Youtube link.
...
karate_kid = media.Movie("Karate Kid",
                         "Kid in danger of being hurt learns karate to defend himself from enemies",
...
forrest_gump = media.Movie("Forrest Gump",
                           "A mand with a mission to keep on running",
...
harry_potter_sorc_stone = media.Movie("Harry Potter and the Sorcerer's Stone",
                                      "A kid that's a wizard in his blood and heart",
                                      "https://upload.wikimedia.org/wikipedia/en/b/bf/Harry_Potter_and_the_Sorcerer%27s_Stone.jpg",
                                      "https://www.youtube.com/watch?v=VyHV0BRtdxo")

# The favorite movies are put into a list (array) and then we open the page.                                                    
movies = [step_brothers, karate_kid, the_fast_and_the_furious, forrest_gump, iron_man, harry_potter_sorc_stone]
